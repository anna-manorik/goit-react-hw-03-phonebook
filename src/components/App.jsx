...
class App extends Component {
  ...
  handleSubmit = e => {
    ...
    const checkname = this.state.contacts.find(contact => contact.name.includes(name));
  ...
  render() {
    ...
    return (
      ...
      <NameList>
        <NameItem visibleContacts={visibleContacts} onDeleteContact={this.deleteContact} />
      </NameList>
      </>
